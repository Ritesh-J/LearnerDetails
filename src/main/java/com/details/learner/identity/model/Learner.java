package com.details.learner.identity.model;
...
public class Learner {
    ...
    //Constructor
    public Learner(int learner_id, String learner_first_name, String learner_last_name, String learner_email, String learner_password, int course_id) {
